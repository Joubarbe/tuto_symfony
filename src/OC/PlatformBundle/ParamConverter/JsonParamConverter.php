...
class JsonParamConverter implements ParamConverterInterface
{
    ...
    function apply(Request $request, ParamConverter $configuration)
    {
        ...
        // Pour bien faire, il faudrait aussi lever une erreur en cas de JSON invalide (voir https://github.com/sensiolabs/SensioFrameworkExtraBundle/blob/master/Request/ParamConverter/DoctrineParamConverter.php)
